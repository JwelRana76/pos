<x-admin title="Monthly Salary Payment List">
    <x-page-header head="Monthly Salary Payment List" />
    <a href="{{route('salary-payment.create')}}" class="btn btn-sm btn-primary m-2">
        <i class="fas fa-fw fa-plus"></i> New Salary Payment
    </a>
    <div class="row">
        <div class="col-md-12">
            <x-data-table dataUrl="/payrole/salary-payment" id="salary_payments" :columns="$columns" />
        </div>
    </div>
