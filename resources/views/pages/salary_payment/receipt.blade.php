        ...
        <div class="receipt-header" >
            <div id="d1" style="width: 30%;height:100%;float:left;">
                <div class="div1" id="div1">
                    <h3 style="margin-left: -50px;margin-top:40px;text-align: center;font-size:20px;">Salary Payment</h3>
                </div>
            </div>
            ...
            <div style="width: 30%;height:100%;float:right;">
                <div class="div2" id="div2" style="color: white;text-align: right; padding:10px">
                    <h2 style="font-size:20px;">{{ $setting->name }}</h2>
                    <p>{{ $setting->address }}</p>
                    <p>{{ $setting->contact }}</p>
                </div>
            </div>
        ...
        <div class="receipt-body" style="padding: 5px;padding-right: 10px;">
            <div style="width: 100% ; float: left; box-sizing: border-box;padding-right: 15px;">
                ...
                <div style="width:20%;float: left;">
                    <input type="text" style="border:0px;border-bottom:3px dotted #018843;padding-left:10px" value="{{ $salary->voucher_no ?? null }}" disabled>
                </div>
                <div style="width:20%;float: left;">

                </div>
                <div style="width:22.5%;float: right;">
                    <input type="text" style="border:0px;border-bottom:3px dotted #018843;" value="{{date('d-M-Y',strtotime($salary->created_at))}}" disabled>
                </div>
            ...
            <div style="width: 100% ; float: left;margin-top: 10px;">
                ...
                <div style="width:72%;float: left;">
                    <input type="text" style="border:0px;border-bottom:3px dotted #018843;width: 100%;" value="{{$salary->employee->name ?? null}}" disabled>
                </div>
            </div>
            <div style="width: 100% ; float: left;margin-top: 10px;">
                ...
                <div style="width:82.5%;float: left;">
                    <input type="text" style="border:0px;border-bottom:3px dotted #018843;width: 100%;"  value="{{ ucwords($digit->format($salary->amount)) }} Taka Only" disabled>
                </div>
            </div>
            <div style="width: 100% ; float: left;margin-top: 10px;">
                ...
                <div style="width:21.4%;float: right;">
                    <input type="text" style="border:0px;border-bottom:3px dotted #018843;width: 100%;"  value="{{date('d-M-Y',strtotime($salary->created_at))}}" disabled>
                </div>
            </div>
            <div style="width: 100% ; float: left;margin-top: 10px;">
                ...
                <div style="width:29.5%;float: right;">
                    <input type="text" style="border:0px;border-bottom:3px dotted #018843;width: 100%;" value="{{$salary->employee->contact ?? null}}" disabled>
                </div>
            ...
            <div style="width: 100% ; float: left;margin-top: 20px;">
                ...
                <div style="width:25.5%;float: left;">
                    <input type="text" style="border:1px solid gray;width: 70%;height:28px;" value="{{$salary->amount}} /-" disabled>
                </div>
