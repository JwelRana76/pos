<x-admin title="Product Create">
    ...
    <div class="card p-3">
      <x-form method="post" action="{{ route('product.update',$product->id) }}">
      <div class="row">
        <div class="col-md-4">
          <x-input id="name" value="{{ $product->name }}" required/>
        </div>
        <div class="col-md-4">
          <label for="code">Code</label>
          <div class="input-group flex-nowrap">
              <input type="text" required name="code" value="{{ $product->code }}" id="code"
        ...
        <div class="col-md-4">
          <x-select id="category" selectedId="{{ $product->category_id }}" :options="$categories" has-modal modal-open-id="category_model" />
        </div>
        <div class="col-md-4">
          <x-select id="brand" selectedId="{{ $product->brand_id }}" :options="$brands" has-modal modal-open-id="brand_model" />
        </div>
        <div class="col-md-4">
          <x-select id="size" selectedId="{{ $product->size_id }}" :options="$sizes" has-modal modal-open-id="size_model" />
        </div>
        <div class="col-md-4">
          <x-select id="unit" selectedId="{{ $product->unit_id }}" :options="$units" has-modal modal-open-id="unit_model" />
        </div>
        <div class="col-md-4">
          <x-input id="cost"  value="{{ $product->cost }}" required/>
        </div>
        <div class="col-md-4">
          <x-input id="price"  value="{{ $product->price }}" required/>
        </div>
        <div class="col-md-4">
          <x-input id="alert_qty" value="{{ $product->alert_qty }}" required/>
        </div>
        <div class="col-md-4">
