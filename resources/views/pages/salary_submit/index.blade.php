<x-admin title="Monthly Salary">
    <x-page-header head="Monthly Salary" />
    <a href="{{route('salary-submit.create')}}" class="btn btn-sm btn-primary m-2">
        <i class="fas fa-fw fa-plus"></i> New Salary Submit
    </a>
    <div class="row">
        <div class="col-md-12">
