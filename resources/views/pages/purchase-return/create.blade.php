<x-admin title="Purchase Return Create">
    <x-page-header head="Purchase Return Create" />
    <div class="card p-3">
      <x-form method="post" action="{{ route('purchase.return.store') }}">
      <div class="row">
        <div class="col-md-4">
        ...
        <div class="col-md-4">
          <x-select id="supplier" required :options="$suppliers" />
        </div>
